...
function getSiriusXmMetadata(id, parent, title, serviceType) {
...
function getSiriusXmUri(id, sid) {
...
function siriusXM(player, values) {
  ...
  // Play the specified SiriusXM channel or station
    ...
    if (results.length > 0) {
      ...
      const sid = player.system.getServiceId('SiriusXM');
      const serviceType = player.system.getServiceType('SiriusXM');
